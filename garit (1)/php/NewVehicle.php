...
$db = new mysqli('smcse-stuproj00.city.ac.uk','adbt117','200012740','adbt117');
    if ($db->connect_error) {
        ...
        $query_VehicleRegistrationIDNumber = "SELECT VehicleRegistrationIDNumber FROM GARITS_Vehicle WHERE VehicleRegistrationIDNumber ='$VehicleRegistrationIDNumber'";
