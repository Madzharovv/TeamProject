...
<html lang="en">
  <head>
    ...
    <title>Quick fix || All Vehicles</title>
                ...
                <div class="staff__total">
                  <h3 class="staff__total-text">
                    ...
                    <span class="staff__total-number">
                      ...
                      $query_VehicleTotal = "SELECT COUNT(VehicleRegistrationIDNumber) FROM GARITS_Vehicle";
                      $result = $db->query($query_VehicleTotal);
                      $row = $result->fetch_assoc();
                      echo $row["COUNT(VehicleRegistrationIDNumber)"];
                      
                      ?>
                    </span>
                  </h3>
                </div>
                <a href="addvehicle.php" class="staff__cta">Add New</a>
              </div>
            </section>
                ...
                <div class="table__title">
                  <div class="table__head-details">
                    <img
                      ...
                      alt="Photo Icon"
                    />
                    <p class="table__head-description">All Vehicles</p>
                  </div>
                </div>
                <div>
